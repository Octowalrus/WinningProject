	...
	public class Arena {
		...
		public void RunBattle() {
			...
			if(roundOverflow) {
				...
				//winner = highest hp
				if (double.IsNaN(Contestant1.GetHealth()) || Contestant1.GetHealth() <= 0) winner = Contestant2;
				else if (double.IsNaN(Contestant2.GetHealth()) || Contestant1.GetHealth() <= 0) winner = Contestant1;
